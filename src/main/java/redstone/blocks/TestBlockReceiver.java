...
public class TestBlockReceiver extends BlockRedstoneRepeater {

	protected TestBlockReceiver(boolean powered) {
		super(powered);
	...
	protected BlockReceiver(boolean powered, String registryName) {
		super(powered);
