...
import hom.registry.Registrable;
...
public abstract class AbstractDiodeBlock<T extends TileEntity>
extends BlockRedstoneDiode implements Registrable, ContainsTile {
	
	private String registryName;
	
	protected AbstractDiodeBlock(boolean powered, String registryName) {
		super(powered);
